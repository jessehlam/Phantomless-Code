...
yourDIR='C:\Users\Kyle\Documents\GitHub\Phantomless-Code\Jesse';
fdpm.diodes = [657 779 798 829]; %I somehow broke auto diode checking...
% fdpm.diodes = 798; %I somehow broke auto diode checking...
smartfreq=1;
p.savefitgraphs=1;
p.fileWrite=1;
...
if smartfreq==1
    fcalc=freqcalc(guiVal);
end
%Calculates the starting  and ending frequency

if smartfreq==1;
    fdpm.freqrange = [75 fcalc.down]; %Lose the 50mhz noise, use rest of freq band
else
