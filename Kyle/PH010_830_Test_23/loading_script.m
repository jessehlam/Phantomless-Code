...
k  = dir('ACRIN2_778_Test_18\*.mat');
filesnames = {k.name}';
cd PH010_778_Test_18
testData = [];
testProps = [];
amplitudes=[];
phases=[];
...
close all
figure;
plot(freqset,testData(:,2),freqset,amplitudes);
% legend('Data','0.550','0.500','1','0.950','0.900','0.850','0.800','0.750','0.700','0.650','0.600');
legend('Data','0.550','1','0.950','0.900','0.850','0.800','0.750','0.700','0.650','0.600');
title('Freq Range Fits PH010 at 830nm'), xlabel('Freq in GHz'),ylabel('Normalized Amplitude')
