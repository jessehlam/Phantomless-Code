...
plot(ft*1000,FDPM.AMP,'b*'); %Plotting raw tissue amplitude
hold on;
plot(ft*1000,CAL.AMP,'r*'); %plotting raw calibrator amplitude
hold off;
...
if plotrawcal==1
    figure
    plot(ft*1000,rawamp,'b*'); %Plotting the non-normalized amp
    ylabel('Amplitude');
