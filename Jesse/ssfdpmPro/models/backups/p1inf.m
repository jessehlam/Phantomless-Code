...
% Returns phase (radians) and amplitude of P1 infinite PDW
...
%function y = p1inf(f,p,fx,nind,rho1,rho2);
function y = p1inf(p,f,fx,nind,rho1,rho2, wt, reim_flag);
...
Re1 = +(er01./r01).*cos(ki.*r01)./D;
Im1 = +(er01./r01).*sin(ki.*r01)./D;  
...
if(rho2==0),		%flag for single distance = real and imaginary
   ...
   Re2 = (er02./r02).*cos(ki.*r02)./D;
   Im2 = (er02./r02).*sin(ki.*r02)./D;  
